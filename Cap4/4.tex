		...
		\begin{figure}[H]
			...
			\begin{tikzpicture}[scale=1]
				...
				\begin{axis}[grid=both, 
							xlabel=\phantom{$m_{\phi}^G$} $\xi$ \phantom{$m_{\phi}^G$}, 
							ylabel=$S\singleSpacing \%$,
							enlargelimits=false,
							...
							legend entries={$r=10$, $r=50$, $r=120$},
			  				...
			  				extra y ticks ={50,10,4.17},
			  				extra y tick labels={$50$, $10$, $4.17$},
			  				...
			  				extra x ticks ={0.22,0.59,0.7},
			  				extra x tick labels={$0.22$, $0.59$, $0.7$}			  							  		            								
							]
					\addplot[red, dashed] coordinates {(0,50) (0.22,50)};
			    	\addplot[green, dashed] coordinates {(0,10) (0.59,10)};
			    	\addplot[blue, dashed] coordinates {(0,4.17) (0.7,4.17)};
			    	\addplot[red, dashed] coordinates {(0.22,50) (0.22,0)};
			    	\addplot[green, dashed] coordinates {(0.59,10) (0.59,0)};
			    	\addplot[blue, dashed] coordinates {(0.7,4.17) (0.7,0)};							
			    	
			    	\addplot[domain=0:1, blue, ultra thick] {100*e^((-3.14*x)/(1-x^2)^(1/2)};
					    	
				\end{axis}
				
				%\node[red] at (-0.3, 2.8) {$50$};
				%\node[green] at (-0.3, 0.55) {$10$};
			...
			\begin{tikzpicture}[scale=1]
				...
				\begin{axis}[grid=both, 
							...
							legend entries={$r=10$, $r=50$, $r=120$},
			  				...
			  				extra x ticks ={24,59,66},
			  				extra x tick labels={$24$, $59$, $66$},			  		            				
							]
			    	\addplot[red, dashed] coordinates {(0,50) (24,50)};
					\addplot[green, dashed] coordinates {(0,10) (58.5,10)};
			    	\addplot[blue, dashed] coordinates {(0,4.17) (66,4.17)};
			    	\addplot[red, dashed] coordinates {(24,50) (24,0)};
			    	\addplot[green, dashed] coordinates {(58.5,10) (58.5,0)};
			    	\addplot[blue, dashed] coordinates {(66,4.17) (66,0)};							
