			...
			\centering
				\begin{tikzpicture}[scale=0.99]
					...
					grid=major,
			  		...
			  		legend entries={$r=10$, $r=50$, $r=120$},
						...
						\addplot[red] table {./4/raw/in_r_10_d__0_5.dat};
						\addplot[green] table {./4/raw/in_r_50_d__0_5.dat};
						\addplot[blue] table {./4/raw/in_r_120_d__0_5.dat};
				...
				\begin{tikzpicture}[scale=0.99]
					...
					grid=major,
			  		...
			  		xtick={1000,1200,...,1600},
			  		xticklabels={$1$, $1.2$, $1.42$, $1.6$},
			  		ytick={0, 100, 150},
			  		...
			  		legend entries={$r=10$, $r=50$, $r=120$},
						...
						\addplot[red] table {./4/raw/out_r_10_d__0_5.dat};
						\addplot[green] table {./4/raw/out_r_50_d__0_5.dat};
						\addplot[blue] table {./4/raw/out_r_120_d__0_5.dat};
